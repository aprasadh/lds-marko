...
test('Blank Check', function (context) {
  ...
  expect(output.$('div.slds-form-element').children('label').attr('for')).to.be.not.null;
  ...
  expect(output.$('div.slds-form-element').children('div').children('input').attr('id')).to.be.not.null;
